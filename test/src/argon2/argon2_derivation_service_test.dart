...
void main() {
  group('Argon2DerivationService Tests', () {
    ...
    test('deriveWithHighMemory returns a non-null derived hash', () {
      ...
      final derivedHash = argon2Service.highMemoryIterativeDerivation(1, entropyBytes);
    ...
    test('deriveWithHighMemory is deterministic for the same input', () {
      final derivedHash1 = argon2Service.highMemoryIterativeDerivation(1, entropyBytes);
      final derivedHash2 = argon2Service.highMemoryIterativeDerivation(1, entropyBytes);
    ...
    test('deriveWithHighMemory produces different hashes for different inputs',
      ...
      final derivedHash1 = argon2Service.highMemoryIterativeDerivation(1, entropyBytes);
      final derivedHash2 = argon2Service.highMemoryIterativeDerivation(1, entropyBytes2);
    ...
    test('deriveWithHighMemory with multiple iterations produces different results',
        () {
      final derivedHash1 = argon2Service.highMemoryIterativeDerivation(1, entropyBytes);
      final derivedHash2 = argon2Service.highMemoryIterativeDerivation(2, entropyBytes);
    ...
    test('deriveWithModerateMemory returns a valid derived hash', () {
      ...
      final derivedHash = argon2Service.moderateMemoryDerivation(entropyBytes);
    ...
    test('deriveWithModerateMemory is deterministic for the same input', () {
      final derivedHash1 = argon2Service.moderateMemoryDerivation(entropyBytes);
      final derivedHash2 = argon2Service.moderateMemoryDerivation(entropyBytes);
    ...
    test('deriveWithModerateMemory produces different hashes for different inputs',
      ...
      final derivedHash1 = argon2Service.moderateMemoryDerivation(entropyBytes);
      final derivedHash2 = argon2Service.moderateMemoryDerivation(entropyBytes2);
